...
export function EditEventDialog({ open, onOpenChange, event, onSuccess, onDelete, onPublished }: EditEventDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg" style={{ maxHeight: "90vh", overflowY: "auto", overflowX: "hidden", scrollbarWidth: "thin", scrollbarColor: "rgba(239,68,68,0.3) transparent" }}>
        <DialogHeader>
