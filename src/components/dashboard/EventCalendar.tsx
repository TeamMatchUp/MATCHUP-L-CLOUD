...
export function EventCalendar({ events, highlightedDates = [] }: EventCalendarProps) {
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      <h3 className="font-heading text-foreground mb-3" style={{ fontSize: "1.125rem", letterSpacing: "0.04em" }}>
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-medium text-foreground text-center whitespace-nowrap flex-1">
