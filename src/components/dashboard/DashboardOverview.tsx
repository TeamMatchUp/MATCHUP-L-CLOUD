...
export function DashboardOverview({
  ...
  const toggleCardVisibility = (card: keyof typeof cardVisibility) => {
  ...
  // Only show the coach layout for coach/gym_owner roles
  if (!isCoachOrOwner) {
    return (
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="relative">
          ...
          {showQuickActions && (
            <>
              ...
              <div className="absolute right-0 top-11 z-50 min-w-[220px] rounded-xl border bg-accent/95 backdrop-blur-sm shadow-xl p-2"
      ...
      <div
        ...
        style={{
          opacity: cardVisibility.kpis ? 1 : 0,
          maxHeight: cardVisibility.kpis ? "400px" : "0px",
        }}
      >
        {cardVisibility.kpis && <CoachKpiStrip />}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div
          ...
          style={{
            opacity: cardVisibility.fights ? 1 : 0,
            maxHeight: cardVisibility.fights ? "2000px" : "0px",
            overflow: "hidden",
          }}
        >
          {cardVisibility.fights && <CoachUpcomingFights />}
        </div>
        ...
        <div
          ...
          style={{
            opacity: cardVisibility.calendar ? 1 : 0,
            maxHeight: cardVisibility.calendar ? "2000px" : "0px",
            overflow: "hidden",
          }}
        >
          {cardVisibility.calendar && (
            <EventCalendar events={calendarEvents} highlightedDates={highlightedDates} />
          )}
        </div>
      </div>
